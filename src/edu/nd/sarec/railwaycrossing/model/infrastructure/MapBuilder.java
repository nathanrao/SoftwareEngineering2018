...
public class MapBuilder {
	...
	private void buildRoads(){
		...
		roads.put("EastWest",new Road(new Point(415,667),new Point (785,667),Direction.EAST,true,true));	
	}
	...
	private void buildTracks(){
		...
		tracks.put("Real", new RailwayTracks(new Point(0,550),new Point(1200,550)));
	}
